...
const sounds = [
    { name: 'Rain', icon: '💧', color: '#96616B', file: 'sounds/rain.wav', type: 'audio/wav' },
    { name: 'Thunder', icon: '⚡', color: '#75485E', file: 'sounds/thunder.wav' },
    { name: 'Waves', icon: '🌊', color: '#84A59D', file: 'sounds/waves.wav' },
    { name: 'Forest', icon: '🌳', color: '#89A894', file: 'sounds/forest.wav' },
    { name: 'Fire', icon: '🔥', color: '#C17767', file: 'sounds/fire.wav' },
    { name: 'Birds', icon: '🐦', color: '#A7B8A8', file: 'sounds/birds.wav' },
    { name: 'City', icon: '🏙️', color: '#8E8E8E', file: 'sounds/city.wav' },
    { name: 'Wind', icon: '💨', color: '#B4A6AB', file: 'sounds/wind.wav' },
    { name: 'Stream', icon: '🏞️', color: '#7B9EA8', file: 'sounds/stream.wav' },
    { name: 'White Noise', icon: '📻', color: '#60452A', file: 'sounds/whitenoise.wav' },
    { name: 'Cafe', icon: '☕', color: '#5d4037', file: 'sounds/cafe.mp3' },
    { name: 'Beach', icon: '🏖️', color: '#CD9136', file: 'sounds/beach.wav' },
    { name: 'Bell', icon: '🔔', color: '#5C7995', file: 'sounds/bell.wav' },
    { name: 'Keyboard', icon: '����️', color: '#E6BCBC', file: 'sounds/keyboard.wav' },
    { name: 'Bubbles', icon: '🫧', color: '#88867B', file: 'sounds/bubbles.wav' },
    { name: 'Horse', icon: '🐎', color: '#D49DAA', file: 'sounds/horse.wav' },
    { name: 'Shower', icon: '🚿', color: '#00695c', file: 'sounds/shower.wav' },
    { name: 'Book', icon: '📚', color: '#a1887f', file: 'sounds/book.wav' },
];
